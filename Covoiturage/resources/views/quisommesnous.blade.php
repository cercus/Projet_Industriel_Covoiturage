...
L'objectif est de réaliser, en groupe, une page web de A à Z comme si nous étions en entreprise.
    ...
    <div class="row">
        ...
        <div class="gallery colonne-5">
            ...
            <div>
                ...
                en particulier ce projet, j’ai pu développer mes compétences en programmation et 
                en résolution des problèmes, tout en possédant de solides bases en développement, 
                qui me permet une projection facile sur les technologies fréquentes du Web.
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="gallery colonne-5">
            ...
            <div>
                ...
                <div class="desc">
                    ...
                    master Compétence Complémentaire en Informatique (CCI). J’ai choisi d’une part ce master pour la 
                    qualité des enseignements et le fait que ce master permet d’ouvrir beaucoup de portes dans le monde 
                    de l’informatique. D’autre part, j’ai commencé la programmation il y a de cela 5 ans, en partie 
                    grâce à Minecraft et son côté serveur et depuis je n’arrête pas de créer des programmes dans divers 
                    langages.
                </div>
            </div>
