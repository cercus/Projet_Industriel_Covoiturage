...
<form method="POST" action="{{route('rechercheTrajet.post')}}">
    @csrf
    @if ($errors->any())
    ...
    <button type="submit" class="button-form-accueil margin-bottom-accueil">Rechercher</button>
</form>


<div class="margin-bottom-accueil center-title">
    <h2>Les trajets aux meilleurs prix aujourd'hui</h2>
</div>
    <div>
    ...
    <div class="border border-dark margin-trajetsBest">
        <div class="row ml-5 mt-3">
            <div class="v-list-item__title">
                ...
                {{ $bestTrajet['jour'] }} {{ $bestTrajet['date'] }}
                </div>
            </div>
        ...
        <div class="row mb-3 mt-2 ml-5">
            <div class="pmd-user-info col-md-8">
                ...
                <!-- nom du conducteur -->
                <span class="text-h6">{{ $bestTrajet['nom'] }} {{ $bestTrajet['prenom'] }}</span>
            </div>
            <!-- button plus détails -->
            <div class="col-md-4 mt-2">
                <button class="btn button-form ml-5"><a href="{{route('detailsResultRechercheTrajet', ['trajetId'=>$bestTrajet['id']])}}">PLUS DÉTAILS</a></button>
            </div>
        </div> 
    </div>
&nbsp
